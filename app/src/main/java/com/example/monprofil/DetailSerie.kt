...
@Composable
fun SerieScreen(id: String, windowClass: WindowSizeClass, viewModel: MainViewModel) {
...
@Composable
private fun detailSerie(movie:TmdbMovieDetail): LazyGridScope.() -> Unit = {
    item {
