...
@Composable
fun ActeursScreen(viewModel: MainViewModel,windowClass: WindowSizeClass){
    ...
    when (windowClass.widthSizeClass) {
        WindowWidthSizeClass.Compact -> {
            LazyVerticalGrid(
                ...
                verticalArrangement = Arrangement.spacedBy(30.dp), content = CardActeur(acteurs)
            )
        }
...
@Composable
private fun CardActeur(acteurs: List<TmdbActor>): LazyGridScope.() -> Unit =
    {
